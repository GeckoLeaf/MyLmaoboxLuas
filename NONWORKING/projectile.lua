-- This enum is taken from FedoraWare.
local TF_WEAPONS_ENUM = {
...
-- This code has been converted from FedoraWare.
local function getProjectileInfo(id)
    local projectileInfo = { Velocity = 0.0, Gravity = 0.0, MaxTime = 0.0 }
    if id == TF_WEAPONS_ENUM.Soldier_m_RocketLauncher or id == TF_WEAPONS_ENUM.Soldier_m_RocketLauncherR or id == TF_WEAPONS_ENUM.Soldier_m_TheBlackBox or id == TF_WEAPONS_ENUM.Soldier_m_TheCowMangler5000 or id == TF_WEAPONS_ENUM.Soldier_m_TheOriginal or id == TF_WEAPONS_ENUM.Soldier_m_FestiveRocketLauncher or id == TF_WEAPONS_ENUM.Soldier_m_TheBeggarsBazooka or id == TF_WEAPONS_ENUM.Soldier_m_SilverBotkillerRocketLauncherMkI or id == TF_WEAPONS_ENUM.Soldier_m_GoldBotkillerRocketLauncherMkI or id == TF_WEAPONS_ENUM.Soldier_m_RustBotkillerRocketLauncherMkI or id == TF_WEAPONS_ENUM.Soldier_m_BloodBotkillerRocketLauncherMkI or id == TF_WEAPONS_ENUM.Soldier_m_CarbonadoBotkillerRocketLauncherMkI or id == TF_WEAPONS_ENUM.Soldier_m_DiamondBotkillerRocketLauncherMkI or id == TF_WEAPONS_ENUM.Soldier_m_SilverBotkillerRocketLauncherMkII or id == TF_WEAPONS_ENUM.Soldier_m_GoldBotkillerRocketLauncherMkII or id == TF_WEAPONS_ENUM.Soldier_m_FestiveBlackBox or id == TF_WEAPONS_ENUM.Soldier_m_TheAirStrike or id == TF_WEAPONS_ENUM.Soldier_m_WoodlandWarrior or id == TF_WEAPONS_ENUM.Soldier_m_SandCannon or id == TF_WEAPONS_ENUM.Soldier_m_AmericanPastoral or id == TF_WEAPONS_ENUM.Soldier_m_SmalltownBringdown or id == TF_WEAPONS_ENUM.Soldier_m_ShellShocker or id == TF_WEAPONS_ENUM.Soldier_m_AquaMarine or id == TF_WEAPONS_ENUM.Soldier_m_Autumn or id == TF_WEAPONS_ENUM.Soldier_m_BlueMew or id == TF_WEAPONS_ENUM.Soldier_m_BrainCandy or id == TF_WEAPONS_ENUM.Soldier_m_CoffinNail or id == TF_WEAPONS_ENUM.Soldier_m_HighRollers or id == TF_WEAPONS_ENUM.Soldier_m_Warhawk then
        projectileInfo.Velocity = 1100.0
        projectileInfo.Gravity = 0.0
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Soldier_m_TheDirectHit then
        projectileInfo.Velocity = 1980.0
        projectileInfo.Gravity = 0.0
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Soldier_m_TheLibertyLauncher then
        projectileInfo.Velocity = 1540.0
        projectileInfo.Gravity = 0.0
        projectileInfo.MaxTime = 0.0
	elseif id == TF_WEAPONS_ENUM.Demoman_m_GrenadeLauncher or id == TF_WEAPONS_ENUM.Demoman_m_GrenadeLauncherR or id == TF_WEAPONS_ENUM.Demoman_m_FestiveGrenadeLauncher or id == TF_WEAPONS_ENUM.Demoman_m_TheIronBomber or id == TF_WEAPONS_ENUM.Demoman_m_Autumn or id == TF_WEAPONS_ENUM.Demoman_m_MacabreWeb or id == TF_WEAPONS_ENUM.Demoman_m_Rainbow or id == TF_WEAPONS_ENUM.Demoman_m_SweetDreams or id == TF_WEAPONS_ENUM.Demoman_m_CoffinNail or id == TF_WEAPONS_ENUM.Demoman_m_TopShelf or id == TF_WEAPONS_ENUM.Demoman_m_Warhawk or id == TF_WEAPONS_ENUM.Demoman_m_ButcherBird then
        projectileInfo.Velocity = 1216.0
        projectileInfo.Gravity = 0.5
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Soldier_s_TheRighteousBison or id == TF_WEAPONS_ENUM.Engi_m_ThePomson6000 then
        projectileInfo.Velocity = 1200.0
        projectileInfo.Gravity = 0.0
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Demoman_m_TheLooseCannon then
        projectileInfo.Velocity = 1453.9
        projectileInfo.Gravity = 0.5
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Demoman_m_TheLochnLoad then
        projectileInfo.Velocity = 1513.3
        projectileInfo.Gravity = 0.5
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Engi_m_TheRescueRanger or id == TF_WEAPONS_ENUM.Medic_m_FestiveCrusadersCrossbow or id == TF_WEAPONS_ENUM.Medic_m_CrusadersCrossbow then
        projectileInfo.Velocity = 2400.0
        projectileInfo.Gravity = 0.2
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Pyro_m_DragonsFury then
        projectileInfo.Velocity = 3000.0
        projectileInfo.Gravity = 0.0
        projectileInfo.MaxTime = 0.1753
    elseif id == TF_WEAPONS_ENUM.Pyro_m_FlameThrower or id == TF_WEAPONS_ENUM.Pyro_m_FlameThrowerR or id == TF_WEAPONS_ENUM.Pyro_m_TheBackburner or id == TF_WEAPONS_ENUM.Pyro_m_TheDegreaser or id == TF_WEAPONS_ENUM.Pyro_m_ThePhlogistinator or id == TF_WEAPONS_ENUM.Pyro_m_FestiveFlameThrower or id == TF_WEAPONS_ENUM.Pyro_m_TheRainblower or id == TF_WEAPONS_ENUM.Pyro_m_SilverBotkillerFlameThrowerMkI or id == TF_WEAPONS_ENUM.Pyro_m_GoldBotkillerFlameThrowerMkI or id == TF_WEAPONS_ENUM.Pyro_m_RustBotkillerFlameThrowerMkI or id == TF_WEAPONS_ENUM.Pyro_m_BloodBotkillerFlameThrowerMkI or id == TF_WEAPONS_ENUM.Pyro_m_CarbonadoBotkillerFlameThrowerMkI or id == TF_WEAPONS_ENUM.Pyro_m_DiamondBotkillerFlameThrowerMkI or id == TF_WEAPONS_ENUM.Pyro_m_SilverBotkillerFlameThrowerMkII or id == TF_WEAPONS_ENUM.Pyro_m_GoldBotkillerFlameThrowerMkII or id == TF_WEAPONS_ENUM.Pyro_m_FestiveBackburner or id == TF_WEAPONS_ENUM.Pyro_m_ForestFire or id == TF_WEAPONS_ENUM.Pyro_m_BarnBurner or id == TF_WEAPONS_ENUM.Pyro_m_BovineBlazemaker or id == TF_WEAPONS_ENUM.Pyro_m_EarthSkyandFire or id == TF_WEAPONS_ENUM.Pyro_m_FlashFryer or id == TF_WEAPONS_ENUM.Pyro_m_TurbineTorcher or id == TF_WEAPONS_ENUM.Pyro_m_Autumn or id == TF_WEAPONS_ENUM.Pyro_m_PumpkinPatch or id == TF_WEAPONS_ENUM.Pyro_m_Nutcracker or id == TF_WEAPONS_ENUM.Pyro_m_Balloonicorn or id == TF_WEAPONS_ENUM.Pyro_m_Rainbow or id == TF_WEAPONS_ENUM.Pyro_m_CoffinNail or id == TF_WEAPONS_ENUM.Pyro_m_Warhawk or id == TF_WEAPONS_ENUM.Pyro_m_NostromoNapalmer then
        projectileInfo.Velocity = 1000.0
        projectileInfo.Gravity = 0.0
        projectileInfo.MaxTime = 0.33
    elseif id == TF_WEAPONS_ENUM.Pyro_s_TheDetonator or id == TF_WEAPONS_ENUM.Pyro_s_TheFlareGun or id == TF_WEAPONS_ENUM.Pyro_s_FestiveFlareGun or id == TF_WEAPONS_ENUM.Pyro_s_TheScorchShot then
        projectileInfo.Velocity = 2000.0
        projectileInfo.Gravity = 0.3
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Pyro_s_TheManmelter or id == TF_WEAPONS_ENUM.Scout_s_TheFlyingGuillotine or id == TF_WEAPONS_ENUM.Scout_s_TheFlyingGuillotineG then
        projectileInfo.Velocity = 3000.0
        projectileInfo.Gravity = 0.2
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Medic_m_SyringeGun or id == TF_WEAPONS_ENUM.Medic_m_SyringeGunR or id == TF_WEAPONS_ENUM.Medic_m_TheBlutsauger or id == TF_WEAPONS_ENUM.Medic_m_TheOverdose then
        projectileInfo.Velocity = 1000.0
        projectileInfo.Gravity = 0.2
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Sniper_m_TheHuntsman or id == TF_WEAPONS_ENUM.Sniper_m_FestiveHuntsman or id == TF_WEAPONS_ENUM.Sniper_m_TheFortifiedCompound then
        -- Assume full charge.
        -- This appears to be wrong?
        projectileInfo.Velocity = 2600.0
        projectileInfo.Gravity = 0.1
        projectileInfo.MaxTime = 0.0
    elseif id == TF_WEAPONS_ENUM.Demoman_s_StickybombLauncher or id == TF_WEAPONS_ENUM.Demoman_s_StickybombLauncherR or id == TF_WEAPONS_ENUM.Demoman_s_FestiveStickybombLauncher or id == TF_WEAPONS_ENUM.Demoman_s_TheScottishResistance or id == TF_WEAPONS_ENUM.Demoman_s_TheQuickiebombLauncher then
        -- Assume full charge.
        -- This appears to be wrong?
        projectileInfo.Velocity = 2400.0
        projectileInfo.Gravity = 0.0
...
-- Incomplete function, values taken from FedoraWare and TF2 source code.
local function getWeaponOffset(weaponId, weaponDefinitionIndex, ducking)
    local offset = Vector3(0, 0, 0)

    if weaponId == E_WeaponBaseID.TF_WEAPON_ROCKETLAUNCHER or weaponId == E_WeaponBaseID.TF_WEAPON_DIRECTHIT then
        if weaponDefinitionIndex == TF_WEAPONS_ENUM.Soldier_m_TheOriginal then
            offset = Vector3(23.5, 0.0, ducking and 8.0 or -3.0)
        else
            offset = Vector3(23.5, 12.0, ducking and 8.0 or -3.0)
        end
    elseif weaponId == E_WeaponBaseID.TF_WEAPON_GRENADELAUNCHER then
        offset = Vector3(16, 8, -6.0)
    elseif weaponId == E_WeaponBaseID.TF_WEAPON_PIPEBOMBLAUNCHER then
        offset = Vector3(16, 8, -6.0)
    end
...
-- Custom function, weapon:GetProjectileFireSetup and this seem to return the same information.
local function fixProjectileOrigin(entity, angles, offset)
    return entity:GetAbsOrigin() + entity:GetPropVector("m_vecViewOffset[0]") + (angles:Forward() * offset.x) + (angles:Right() * offset.y) + (angles:Up() * offset.z)
end

-- This model doesn't matter as far as I know.
local projectileModel = "models/weapons/w_models/w_grenade_grenadelauncher.mdl"

-- Setup envrionment as documented.
...
local projectileModelSolid, projectileModelCollisionModel = physics.ParseModelByName(projectileModel)
...
callbacks.Register("Draw", function()
    ...
    local weaponDefinitionIndex = weapon:GetPropInt("m_iItemDefinitionIndex")
    if not weaponDefinitionIndex then
        return
    end

    -- Get projectile info from function copied from FedoraWare
    -- I do not know if these variables are accurate.
    local projectileInfo = getProjectileInfo(weaponDefinitionIndex)
    if projectileInfo.Velocity == 0.0 and projectileInfo.Gravity == 0.0 and projectileInfo.MaxTime == 0.0 then
        return
    end

    -- Set gravity (base 800) times projectile gravity
    physicsEnvironment:SetGravity(Vector3(0, 0, -800 * projectileInfo.Gravity))
    -- This is commented because I was seeing if my gravity calculation was the issue but it does not seem to make a difference.
    --physicsEnvironment:SetGravity(Vector3(0, 0, -800))
    
    -- Copied from documentation
    if not simulatedProjectile then
        simulatedProjectile = physicsEnvironment:CreatePolyObject(projectileModelCollisionModel, projectileModelSolid:GetSurfacePropName(), projectileModelSolid:GetObjectParameters())
        simulatedProjectile:Wake()
    end

    -- m_angEyeAngles returns nil so this is the best I can do.
    local engineViewAngles = engine:GetViewAngles()
    -- Convert to Vector3 because simulatedProjectile:SetPosition expects a Vector3?
    local engineViewAnglesVector = Vector3(engineViewAngles.x, engineViewAngles.y, engineViewAngles.z)

    local ducking = me:GetPropBool("m_bDucking")

    -- Get variable from code copied from FedoraWare and TF2 code
    local projectileStartOffset = getWeaponOffset(weapon:GetWeaponID(), weaponDefinitionIndex, ducking)

    -- This is commented because projectileStartPosition returns the same as my custom code and projectileViewAnglesForward seems to be wrong from weapon:GetProjectileFireSetup.
    --local projectileStartPosition, projectileViewAnglesForward = weapon:GetProjectileFireSetup(me, projectileStartOffset, true, 2^32)
    local projectileStartPosition = fixProjectileOrigin(me, engineViewAngles, projectileStartOffset)

    -- Copied from documentation
    simulatedProjectile:SetPosition(projectileStartPosition, engineViewAnglesVector, true)

    -- This seems logical?
    local velocity = engineViewAngles:Forward() * projectileInfo.Velocity

    -- Commented because projectileViewAnglesForward appears to be incorrect from weapon:GetProjectileFireSetup.
    --local velocity = projectileViewAnglesForward * projectileInfo.Velocity
    
    -- Copied from documentation, does not appear to matter.
    local angularVelocity = Vector3(600, 0, 0)

    -- Copied from documentation
    simulatedProjectile:SetVelocity(velocity, angularVelocity)

    local tickInterval = globals.TickInterval()
    local simulationEnd = physicsEnvironment:GetSimulationTime() + 10
    while physicsEnvironment:GetSimulationTime() < simulationEnd do
        local currentPosition, currentAngle = simulatedProjectile:GetPosition()

        -- Detect if we hit the world and prediction will be inaccurate.
        local shouldBreak = false
        local traceResult = engine.TraceLine(projectileStartPosition, currentPosition, MASK_SHOT_HULL)
        if traceResult.fraction ~= 1.0 then
            -- Commented because it is not needed and the math is wrong?
            --currentPosition = (projectileStartPosition + currentPosition * traceResult.fraction)
            shouldBreak = true
        end

        -- Copied from documentation.
        local screenCurrentPosition = client.WorldToScreen(currentPosition)
        local screenStartPosition = client.WorldToScreen(projectileStartPosition)

        if screenCurrentPosition ~= nil and screenStartPosition ~= nil then
            draw.Color(0, 255, 0, 255)
            draw.Line(screenStartPosition[1], screenStartPosition[2], screenCurrentPosition[1], screenCurrentPosition[2])

            if shouldBreak then
                draw.OutlinedRect(screenCurrentPosition[1] - 5, screenCurrentPosition[2] - 5, screenCurrentPosition[1] + 5, screenCurrentPosition[2] + 5)
            end
        end
        ...
        projectileStartPosition = currentPosition

        physicsEnvironment:Simulate(tickInterval)
    end
...
callbacks.Register("Unload", function()
    if simulatedProjectile ~= nil then
        physicsEnvironment:DestroyObject(simulatedProjectile)
    end
